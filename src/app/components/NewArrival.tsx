...
import Striped from '../../../public/t-shirt.png'
import Graphic from '../../../public/jeans.png'
import Shorts from '../../../public/shirt.png'
import Skinny from '../../../public/sleeves.png'
import React from 'react'

const TopSelling = () => {
  return (
    <div className='container grid md:grid-1 w-full px-[120px] py-[493] mt-10 p-20'>
        <h1 className="text-3xl font-extrabold text-center mb-6">TOP SELLING
        </h1>
        ...
        <div>
            ...
            height={298}
            />
            <h3 className="mt-4 text-lg font-semibold">T-SHIRT WITH TAPE DETAILS</h3>
